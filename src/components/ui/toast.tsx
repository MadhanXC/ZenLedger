...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex w-full flex-col-reverse gap-2 p-4 sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col sm:max-w-[320px]",
      className
    )}
    {...props}
  />
...
const toastVariants = cva(
  [
    "group pointer-events-auto relative flex w-full items-start",
